...
export default function LandingPage() {
  ...
  return (
    <div className="w-full min-h-screen relative bg-[#F7F5F3] overflow-x-hidden flex flex-col justify-start items-center">
      {/* Fixed nav — sits on top of hero and stays on scroll */}
      <header className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center h-14 sm:h-16 md:h-[84px] px-4 sm:px-6 md:px-8">
        <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[700px] lg:max-w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-white/10 backdrop-blur-md border border-white/20 overflow-hidden rounded-[50px] flex justify-between items-center">
          <div className="flex justify-center items-center">
            ...
            <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 flex justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
              <a href="#" className="flex flex-col justify-center text-white/85 hover:text-white text-xs md:text-[13px] font-medium leading-[14px] font-sans transition-colors">
                Products
              </a>
              <a href="#" className="flex flex-col justify-center text-white/85 hover:text-white text-xs md:text-[13px] font-medium leading-[14px] font-sans transition-colors">
                Pricing
          ...
          <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
            <a href="#" className="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-white/20 hover:bg-white/30 backdrop-blur-sm overflow-hidden rounded-full flex justify-center items-center transition-colors">
              <span className="flex flex-col justify-center text-white text-xs md:text-[13px] font-medium leading-5 font-sans">
                Log in
              </span>
            </a>
          </div>
      ...
      <div className="relative flex flex-col justify-start items-center w-full">
        ...
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start">
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            {/* Dashboard & features — below cinematic hero */}
            <div className="w-full pt-12 sm:pt-16 md:pt-20 pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
