...
export default function LandingPage() {
  ...
  return (
    <div className="w-full min-h-screen relative bg-white overflow-x-hidden flex">
      {/* Side navigation */}
      <aside className="fixed left-0 top-0 bottom-0 z-30 w-52 lg:w-60 flex flex-col border-r border-[rgba(55,50,47,0.12)] bg-white">
        <div className="p-6 border-b border-[rgba(55,50,47,0.08)]">
          <div className="text-[#2F3037] text-lg lg:text-xl font-medium leading-5 font-sans">
            Brillance
          </div>
        </div>
        <nav className="flex-1 flex flex-col gap-1 p-4">
          <a href="#products" className="text-[rgba(49,45,43,0.80)] hover:text-[#37322F] text-sm font-medium leading-9 font-sans py-2 px-3 rounded-lg hover:bg-[rgba(55,50,47,0.06)] transition-colors">
            Products
          </a>
          <a href="#pricing" className="text-[rgba(49,45,43,0.80)] hover:text-[#37322F] text-sm font-medium leading-9 font-sans py-2 px-3 rounded-lg hover:bg-[rgba(55,50,47,0.06)] transition-colors">
            Pricing
          </a>
          <a href="#docs" className="text-[rgba(49,45,43,0.80)] hover:text-[#37322F] text-sm font-medium leading-9 font-sans py-2 px-3 rounded-lg hover:bg-[rgba(55,50,47,0.06)] transition-colors">
            Docs
          </a>
        </nav>
        <div className="p-4 border-t border-[rgba(55,50,47,0.08)]">
          <div className="px-4 py-2 bg-[rgba(55,50,47,0.08)] rounded-full inline-flex justify-center items-center">
            <span className="text-[#37322F] text-sm font-medium leading-5 font-sans">Log in</span>
          </div>
        </div>
      </aside>

      {/* Main content */}
      <main className="flex-1 min-h-screen ml-52 lg:ml-60 flex flex-col justify-start items-center">
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          {/* Left vertical line */}
          <div className="w-[1px] h-full absolute left-4 sm:left-6 md:left-8 lg:left-0 top-0 bg-[rgba(55,50,47,0.12)] z-0"></div>

          {/* Right vertical line */}
          <div className="w-[1px] h-full absolute right-4 sm:right-6 md:right-8 lg:right-0 top-0 bg-[rgba(55,50,47,0.12)] z-0"></div>

          <div className="self-stretch pt-12 sm:pt-14 overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            {/* Hero Section */}
