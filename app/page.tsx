...
export default function LandingPage() {
  ...
  return (
    <div className="w-full min-h-screen relative bg-gradient-to-b from-sky-50 to-violet-50 overflow-x-hidden flex flex-col justify-start items-center">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    ...
                    <div className="border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 bg-transparent">
                      ...
                      <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] rounded-lg flex overflow-hidden justify-center items-center relative bg-transparent">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-sky-50/80 to-transparent pointer-events-none"></div>
                      </div>
                    </div>
