            ...
            >
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#92400E" }}
                    >
                      2:00
                    </span>
                    <span
                  ...
                  <div style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#92400E" }}>
                    1:1 with Heather
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#0C4A6E" }}
                    >
                      2:00
                    </span>
                    <span
                  ...
                  <div style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#0C4A6E" }}>
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#064E3B" }}
                    >
                      9:00
                    </span>
                    <span
                  ...
                  <div style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#064E3B" }}>
                    Webinar: Figma ...
                  </div>
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#581C87" }}
                    >
                      11:00
                    </span>
                    <span
                  ...
                  <div style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#581C87" }}>
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#BE123C" }}
                    >
                      4:00
                    </span>
                    <span
                  ...
                  <div style={{ fontFamily: "Georgia, serif", fontWeight: 300, fontSize: "9px", color: "#BE123C" }}>
                    🍷 Happy Hour
                  </div>
                </div>
              </div>
