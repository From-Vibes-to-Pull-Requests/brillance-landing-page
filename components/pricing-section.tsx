  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2">
      ...
      <div className="self-stretch px-6 md:px-16 py-9 relative flex justify-center items-center gap-4">
        ...
        {/* Toggle Container */}
        <div className="p-3 relative bg-zinc-800 border border-zinc-600 flex justify-center items-center rounded-lg z-20">
          <div className="p-[2px] bg-zinc-700 rounded-[99px] border border-zinc-600 flex justify-center items-center gap-[2px] relative">
            <div
              className={`absolute top-[2px] w-[calc(50%-1px)] h-[calc(100%-4px)] bg-zinc-600 rounded-[99px] transition-all duration-300 ease-in-out ${
            ...
            >
              <div
                className={`text-[13px] font-medium leading-5 font-sans transition-colors duration-300 ${
                  billingPeriod === "annually" ? "text-zinc-100" : "text-zinc-500"
                }`}
              >
                Annually
              </div>
            ...
            >
              <div
                className={`text-[13px] font-medium leading-5 font-sans transition-colors duration-300 ${
                  billingPeriod === "monthly" ? "text-zinc-100" : "text-zinc-500"
                }`}
              >
                Monthly
              </div>
      ...
      <div className="self-stretch border-b border-t border-[rgba(55,50,47,0.12)] flex justify-center items-center">
        <div className="flex justify-center items-start w-full">
          ...
          <div className="w-12 self-stretch relative overflow-hidden hidden md:block">
            <div className="w-[162px] left-[-58px] top-[-120px] absolute flex flex-col justify-start items-start">
              {Array.from({ length: 200 }).map((_, i) => (
                <div
                  key={i}
                  className="self-stretch h-4 rotate-[-45deg] origin-top-left outline outline-[0.5px] outline-zinc-600 outline-offset-[-0.25px]"
                ></div>
              ))}
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col md:flex-row justify-center items-center gap-6 py-12 md:py-0">
            {/* Starter Plan */}
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 border border-zinc-600 overflow-hidden flex flex-col justify-start items-start gap-12 bg-transparent">
              {/* Plan Header */}
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="text-zinc-200 text-lg font-medium leading-7 font-sans">Starter</div>
                  <div className="w-full max-w-[242px] text-zinc-400 text-sm font-normal leading-5 font-sans">
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="flex flex-col justify-start items-start gap-1">
                    <div className="relative h-[60px] flex items-center text-zinc-100 text-5xl font-medium leading-[60px] font-serif">
                    ...
                    <div className="text-zinc-500 text-sm font-medium font-sans">
              ...
              <div className="self-stretch flex flex-col justify-start items-start gap-2">
                {[
                  ...
                  <div key={index} className="self-stretch flex justify-start items-center gap-[13px]">
                    ...
                    <div className="flex-1 text-zinc-400 text-[12.5px] font-normal leading-5 font-sans">
                      {feature}
                    </div>
                  </div>
                ))}
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-zinc-700 border border-zinc-600 overflow-hidden flex flex-col justify-start items-start gap-12">
              {/* Plan Header */}
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                ...
                {/* CTA Button */}
                <div className="self-stretch px-4 py-[10px] relative bg-zinc-600 overflow-hidden rounded-[99px] flex justify-center items-center">
                  <div className="max-w-[108px] flex justify-center flex-col text-zinc-100 text-[13px] font-medium leading-5 font-sans">
                    Get started
                  </div>
                </div>
              </div>
            ...
            {/* Enterprise Plan */}
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-zinc-800 border border-zinc-600 overflow-hidden flex flex-col justify-start items-start gap-12">
              {/* Plan Header */}
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="text-zinc-200 text-lg font-medium leading-7 font-sans">Enterprise</div>
                  <div className="w-full max-w-[242px] text-zinc-400 text-sm font-normal leading-5 font-sans">
                ...
                <div className="self-stretch px-4 py-[10px] relative bg-[#2563eb] overflow-hidden rounded-[99px] flex justify-center items-center hover:bg-[#1d4ed8] transition-colors">
