      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-zinc-100 text-xl font-semibold leading-4 font-sans">Brillance</div>
          </div>
          <div className="text-zinc-400 text-sm font-medium leading-[18px] font-sans">
            Coding made effortless
          </div>

          {/* Social Media Icons */}
          <div className="flex justify-start items-start gap-4 text-zinc-200">
            {/* Twitter/X Icon */}
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="self-stretch text-zinc-500 text-sm font-medium leading-5 font-sans">
              Product
            </div>
            <div className="flex flex-col justify-end items-start gap-2">
              <div className="text-zinc-100 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-zinc-200 transition-colors">
                Features
              </div>
              <div className="text-zinc-100 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-zinc-200 transition-colors">
                Pricing
          ...
          {/* Company Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-zinc-500 text-sm font-medium leading-5 font-sans">Company</div>
          ...
          {/* Resources Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-zinc-500 text-sm font-medium leading-5 font-sans">Resources</div>
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-zinc-100 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-zinc-200 transition-colors">
                Terms of use
              </div>
              <div className="self-stretch text-zinc-100 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-zinc-200 transition-colors">
                API Reference
